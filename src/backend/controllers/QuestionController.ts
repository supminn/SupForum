...
export const getAllQuestionsHandler = function (this: any) {
...
export const getQuestionHandler = function (schema: any, request: any) {
...
export const getAllUserQuestionsHandler = function (schema: any, request: any) {
...
export const addQuestionHandler = function (
  this: any,
  schema: any,
  request: any
) {
...
export const editQuestionHandler = function (
  this: any,
  schema: any,
  request: any
) {
...
export const deleteQuestionHandler = function (
  this: any,
  schema: any,
  request: any
) {
