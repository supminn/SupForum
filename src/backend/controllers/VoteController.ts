...
export const getQuestionVotesHandler = function (schema: any, request: any) {
...
export const getAnswerVotesHandler = function (schema: any, request: any) {
...
export const voteQuestionHandler = function (
  this: any,
  schema: any,
  request: any
) {
...
export const voteAnswerHandler = function (
  this: any,
  schema: any,
  request: any
) {
